...
class XLSXWriter
{
	...
	public function writeSheetHeader($sheet_name, array $header_types, $col_options = null, $r = 0)
	{
    ...
    $style = &$col_options;
		...
		if (!$suppress_row)
		{
			...
			$sheet->file_writer->write('<row collapsed="false" customFormat="false" customHeight="false" hidden="false" ht="12.1" outlineLevel="0" r="' . $r . '">');
			foreach ($header_row as $c => $v) {
				...
				$this->writeCell($sheet->file_writer, $r, $c, $v, $number_format_type='n_string', $cell_style_idx);
			}
