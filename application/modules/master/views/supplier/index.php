...
var table= {
	loadData: function() {
		$('#dataTables').DataTable({
			"ajax": {
				"url": "<?php echo site_url('master/supplier') ?>",
				"type": "POST",
				"data": function(d) {
			...
			"columns": [
					...
					{"data": "supplier_code", "orderable": true, "className": "text-left"},
					{"data": "operator_name", "orderable": true, "className": "text-left"},
					{"data": "email", "orderable": true, "className": "text-left"},
					{"data": "mobile", "orderable": true, "className": "text-left"},
					{"data": "phone", "orderable": true, "className": "text-left"},
					{"data": "fax_number", "orderable": true, "className": "text-left"},
					{"data": "address", "orderable": true, "className": "text-left"},
					{"data": "pic", "orderable": true, "className": "text-left"},
